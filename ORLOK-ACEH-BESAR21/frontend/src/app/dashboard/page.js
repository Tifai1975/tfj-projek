...
export default function Dashboard() {
  ...
  const fetchData = async (authToken, role) => {
    ...
    try {
      ...
      if (role === 'ADMIN') {
        ...
        const allTxRes = await fetch(`${API_URL}/api/transaksi`, {
          headers: { 'Authorization': `Bearer ${authToken}` }
        });
        ...
        // Fetch all members
        const membersRes = await fetch(`${API_URL}/api/users/members`);
  ...
  const handleApproveTx = async (txId, action) => {
    try {
      const res = await fetch(`${API_URL}/api/admin/transactions/${txId}/approve`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleEditMemberSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`${API_URL}/api/users/admin/members/${editMemberId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleCreateAnnouncement = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`${API_URL}/api/pengumuman`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleCreateActivity = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`${API_URL}/api/kegiatan`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
